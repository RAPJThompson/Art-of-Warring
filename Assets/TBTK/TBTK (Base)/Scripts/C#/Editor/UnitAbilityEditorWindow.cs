...
public class UnitAbilityEditorWindow : EditorWindow {
	...
	static void InitLabel(){
		...
		effectAttrTypeTooltip[12]="Increase/decrease target's damage reduction from incoming attack";
		effectAttrTypeTooltip[13]="Increase/decrease target's attack per turn";
		effectAttrTypeTooltip[14]="Increase/decrease target's counter attack limit ";
		effectAttrTypeTooltip[15]="Stun target, stop target from doing anything";
		effectAttrTypeTooltip[16]="Prevent target from attack\nTakes binary value: 0-no effect. >0-cannot attack";
		effectAttrTypeTooltip[17]="Prevent target from moving\nTakes binary value: 0-no effect. >0-cannot move";
		effectAttrTypeTooltip[18]="Prevent target from using ability\nTakes binary value: 0-no effect. >0-cannot use ability";
		effectAttrTypeTooltip[19]="Faction gain points\nFor data currency used to purchase unit";
		effectAttrTypeTooltip[20]="Teleport to a specified tile";
		effectAttrTypeTooltip[21]="Spawn a unit";
		effectAttrTypeTooltip[22]="Convert the target unit to the faction of the casting unit";
		effectAttrTypeTooltip[23]="Spawn a collectible";
