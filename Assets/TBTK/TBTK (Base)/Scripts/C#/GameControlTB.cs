...
public class GameControlTB : MonoBehaviour {
	...
	public int minHeightDifference=0;	// minimum height difference before the hit bonus/penalty is applied
	...
	public static bool EnableHeightTB(){ 
		if(instance==null) return false;
		return instance.enableHeight;
	}
	public static int GetMinimumHeightDif(){ if(instance==null) return 10;	return instance.minHeightDifference;}
	public static float GetH2LBonus(){ if(instance==null) return 0;	return instance.highToLowHitBonus; }
	public static float GetL2HPenalty(){ if(instance==null) return 0;	return instance.lowToHighHitPenalty; }
	public static float GetHeightUnit(){ if(instance==null) return 10;	return instance.heightUnit; }
	public static int GetMoveCostH(){ if(instance==null) return 0;	return instance.moveCostPerHeight; }
